...
const CATALOG = [
  ...
  { id: 'brave-browser',   name: 'Brave',                 category: 'Browser',       icon: '🦁', desc: 'Privacy-focused browser with built-in ad blocking', platforms: ['mac','win'], brew: 'brave-browser',        winget: 'Brave.Brave' },
  ...
  // ── Developer Tools ──────────────────────────────────────────────────────────
  { id: 'visual-studio-code', name: 'VS Code',            category: 'Developer',     icon: '⚙️', desc: 'Popular source code editor by Microsoft',          platforms: ['mac','win'], brew: 'visual-studio-code',   winget: 'Microsoft.VisualStudioCode' },
  ...
  { id: 'github-desktop',  name: 'GitHub Desktop',        category: 'Developer',     icon: '🐙', desc: 'Simplified Git workflow by GitHub',                 platforms: ['mac','win'], brew: 'github',               winget: 'GitHub.GitHubDesktop' },
  ...
  { id: 'windows-terminal',name: 'Windows Terminal',      category: 'Developer',     icon: '🖥️', desc: 'Modern terminal for Windows by Microsoft',          platforms: ['win'],       brew: null,                   winget: 'Microsoft.WindowsTerminal' },
  ...
  { id: 'insomnia',        name: 'Insomnia',              category: 'Developer',     icon: '😴', desc: 'REST and GraphQL API client',                       platforms: ['mac','win'], brew: 'insomnia',             winget: 'Insomnia.Insomnia' },
  ...
  { id: 'dbeaver-community',name: 'DBeaver',              category: 'Developer',     icon: '🗃️', desc: 'Universal database tool for developers',            platforms: ['mac','win'], brew: 'dbeaver-community',    winget: 'dbeaver.dbeaver' },
  ...
  { id: 'wireshark',       name: 'Wireshark',             category: 'Developer',     icon: '🦈', desc: 'Network protocol analyzer',                         platforms: ['mac','win'], brew: 'wireshark',            winget: 'WiresharkFoundation.Wireshark' },
  ...
  { id: 'git',             name: 'Git',                   category: 'Developer',     icon: '🔀', desc: 'Distributed version control system', brewType: 'formula', platforms: ['mac','win'], brew: 'git',          winget: 'Git.Git' },
  ...
  { id: 'telegram',        name: 'Telegram',              category: 'Communication', icon: '✈️', desc: 'Fast, secure messaging app',                        platforms: ['mac','win'], brew: 'telegram',             winget: 'Telegram.TelegramDesktop' },
  { id: 'signal',          name: 'Signal',                category: 'Communication', icon: '🔐', desc: 'Private, end-to-end encrypted messaging',           platforms: ['mac','win'], brew: 'signal',               winget: 'OpenWhisperSystems.Signal' },
  ...
  { id: 'obsidian',        name: 'Obsidian',              category: 'Productivity',  icon: '💎', desc: 'Markdown knowledge base and note-taking app',       platforms: ['mac','win'], brew: 'obsidian',             winget: 'Obsidian.Obsidian' },
  ...
  { id: 'handbrake',       name: 'HandBrake',             category: 'Media',         icon: '🎞️', desc: 'Open-source video transcoder',                      platforms: ['mac','win'], brew: 'handbrake',            winget: 'HandBrake.HandBrake' },
  { id: 'obs',             name: 'OBS Studio',            category: 'Media',         icon: '📽️', desc: 'Free streaming and screen recording software',      platforms: ['mac','win'], brew: 'obs',                  winget: 'OBSProject.OBSStudio' },
  ...
  { id: 'audacity',        name: 'Audacity',              category: 'Media',         icon: '🎙️', desc: 'Free, open-source audio editor',                    platforms: ['mac','win'], brew: 'audacity',             winget: 'Audacity.Audacity' },
  { id: 'kodi',            name: 'Kodi',                  category: 'Media',         icon: '📺', desc: 'Open-source home theater software',                 platforms: ['mac','win'], brew: 'kodi',                 winget: 'XBMCFoundation.Kodi' },
  ...
  { id: 'inkscape',        name: 'Inkscape',              category: 'Design',        icon: '🖊️', desc: 'Free, open-source vector graphics editor',          platforms: ['mac','win'], brew: 'inkscape',             winget: 'Inkscape.Inkscape' },
  ...
  { id: 'keepassxc',       name: 'KeePassXC',             category: 'Security',      icon: '🗝️', desc: 'Open-source cross-platform password manager',       platforms: ['mac','win'], brew: 'keepassxc',            winget: 'KeePassXCTeam.KeePassXC' },
  ...
  { id: 'veracrypt',       name: 'VeraCrypt',             category: 'Security',      icon: '🔏', desc: 'Open-source disk encryption software',              platforms: ['mac','win'], brew: 'veracrypt',            winget: 'IDRIX.VeraCrypt' },
  ...
  { id: '7zip',            name: '7-Zip',                 category: 'Utilities',     icon: '🗜️', desc: 'File archiver with high compression ratio',          platforms: ['win'],       brew: null,                   winget: '7zip.7zip' },
  ...
  { id: 'balenaetcher',    name: 'balenaEtcher',          category: 'Utilities',     icon: '💾', desc: 'Flash OS images to SD cards and USB drives',        platforms: ['mac','win'], brew: 'balenaetcher',         winget: 'Balena.Etcher' },
  ...
  { id: 'powertoys',       name: 'PowerToys',             category: 'Utilities',     icon: '⚡', desc: 'Windows system utilities by Microsoft',             platforms: ['win'],       brew: null,                   winget: 'Microsoft.PowerToys' },
  { id: 'autohotkey',      name: 'AutoHotkey',            category: 'Utilities',     icon: '⌨️', desc: 'Windows automation scripting language',             platforms: ['win'],       brew: null,                   winget: 'AutoHotkey.AutoHotkey' },
